export const maps = [
	...
	{
		map: 'The Dead Cliffs',
		twitterQuery: 'trials (Dead Cliffs)',
		activityHash: '945166984',
	},
	{
		map: 'Javelin-4',
		twitterQuery: 'trials (Javelin)',
		activityHash: '176316743',
	},
	{
		map: 'The Burnout',
		twitterQuery: 'trials (Burnout)',
		activityHash: '247771251',
	},
	{
		map: 'Midtown',
		twitterQuery: 'trials (Midtown)',
		activityHash: '64172690',
	},
	{
		map: 'Rusted Lands',
		twitterQuery: 'trials (Rusted OR Lands)',
		activityHash: '609844331',
	},
	{
		map: 'Exodus Blue',
		twitterQuery: 'trials (Exodus OR Blue)',
		activityHash: '114977383',
	},
	{
		map: 'Pacifica',
		twitterQuery: 'trials (Pacifica)',
